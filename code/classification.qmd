...
sens_spec_all <- c("balanced", "90% specificity")
...
Here are the results of all classification thresholds explored in the PvSeroApp: balanced and 90% specificity. The N's for the random forest model classifications based on these classifications are displayed.
