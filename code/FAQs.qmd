...
## How can I count the number of seropositive and seronegative samples?

To do this, use the template code below, assuming that you have followed the steps outlined [here](pvseroapp.qmd).
